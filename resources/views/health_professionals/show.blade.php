                ...
                <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                    ...
                    <div class="col-span-4 sm:col-span-4">
                        ...
                        <div class="bg-white shadow rounded-lg p-6">
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm text-custom-lgray"><span>{{$psychologist->years_of_experience}} &nbsp;</span>yrs of exp.</span>
                                <div class="mt-6 flex flex-wrap gap-4 justify-center">
                                    <a href="mailto:{{$psychologist->user->email}}" target="_blank"
                                        class="bg-custom-blue hover:bg-blue-400 text-white  py-2 px-4 rounded"><span><i class="fa-regular fa-envelope mr-2"></i></span>{{
                                        $psychologist->user->email}}</a>
                                    <a href="tel:{{$psychologist->phone_number}}"
                                        class="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded"><span><i class="fa-solid fa-phone mr-2"></i></span>+251-{{$psychologist->phone_number}}
                                    </a>
                                </div>
                    ...
                    <div class="col-span-4 sm:col-span-8">
                        <div class="bg-white shadow rounded-lg p-6">
                            ...
                            <p class="text-gray-700"> {{$psychologist->about}}</p>
                            ...
                            <div class="flex justify-center items-center gap-6 my-6">
                                @if($psychologist->linkedin)
                                    <a class="text-custom-blue hover:text-orange-600"
                                        aria-label="Visit TrendyMinds LinkedIn" href="{{$psychologist->linkedin}}" target="_blank">
                                ...
                                @endif
                                @if($psychologist->youtube)
                                    <a class="text-custom-blue hover:text-orange-600"
                                        aria-label="Visit TrendyMinds YouTube" href="{{$psychologist->youtube ?: ''}}" target="_blank">
                                ...
                                @endif
                                @if($psychologist->facebook)
                                    <a class="text-custom-blue hover:text-orange-600"
                                        aria-label="Visit TrendyMinds Facebook" href="{{$psychologist->facebook}}" target="_blank">
                                ...
                                @endif
                                @if($psychologist->instagram)
                                    <a class="text-custom-blue hover:text-orange-600"
                                        aria-label="Visit TrendyMinds Instagram" href="{{$psychologist->instagram}}" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-6">
                                            <path fill="currentColor"
                                ...
                                @endif
                                @if($psychologist->twitter)
                                    <a class="text-custom-blue hover:text-orange-600"
                                        aria-label="Visit TrendyMinds Twitter" href="{{$psychologist->twitter}}" target="_blank">
                            ...
                            <div>
                                @if($psychologist->description)
                                <p class="text-gray-700"> {{$psychologist->description}}</p>
                                @else
                            ...
                            <div>
                                @if($psychologist->user->experiences !== [])
                                {{-- @php
                                    dd($psychologist->user->experiences);
                                @endphp --}}
                                    @foreach($psychologist->user->experiences as $experience)
                                    <div class="mb-6">
                                        <div class="flex justify-between flex-wrap gap-2 w-full">
                                            ...
                                            <p>
                                                <span class="text-gray-700 mr-2">{{$experience->company}}</span>
                                            </p>
                                        <div>
                                            <p id="descrip" class="mt-2 line-clamp-3 mx-1">
                                                {{$experience->description}} 
                                            </p>
                                            <button id="seeMore" class="text-sm underline mx-1">See More</button>
                                        </div>

                                        <script>
                                            const description = document.querySelector('#descrip');
                                            let isMore = true; // Change const to let
                                            ...
                                            button.addEventListener('click', (e) => {
                                                ...
                                                isMore = !isMore; // Toggle the value of isMore
                                                console.log(isMore)
                                            });
                                        </script>
                                ...
                                @can('edit-experience', $psychologist)
