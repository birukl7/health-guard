...
<section class="bg-white rounded-2xl m-4 pt-10 p-7 w-full">
  ...
  <div class="flex justify-between items-center px-8">
    <p>
      ...
      <a href="{{route('alcohols.create')}}" class="hover:text-custom-blue underline {{ Request::is('alcohols*') ? $text_color : '' }}">Alcoholism</a>
    </p>
  ...
  <div class="p-4 sm:p-8 bg-white  shadow sm:rounded-lg">
    <div class="max-w-xl">
      @include('alcohols.partials.add-alcholism')
    </div>
  </div>
