        ...
        <ul id="general-nav">
          ...
          <a href="#" class="">
            <li
              ...
              <div><i class="fa-solid fa-house mr-4"></i><span class="">Home</span></div>
            </li>
          </a>
          ...
          <a href="/student/status" class="">
            <li
              class="hover:bg-custom-vlgray hover:border-r-2 rounded-xl rounded-tr-none rounded-br-none cursor-pointer  py-5 pl-6   my-1 {{ Request::path() === '/' ? $bg : '' }}">
              <div><i class="mr-4 fa-solid fa-stairs "></i><span class="">Status</span></div>
            </li>
          </a>
          @endif
          @endauth
